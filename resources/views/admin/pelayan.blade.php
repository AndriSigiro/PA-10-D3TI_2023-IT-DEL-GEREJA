...
<div class="content-wrapper">
    ...
    <h1 class="text-center mb-4" style="font-family: 'Rowdies', cursive;"> Pelayan</h1>
    <div class="container">
        <a href="/tambahpelayan" type="button" class="btn btn-success">Tambah+</a>
        <div class="row">
            ...
            <table class="table">
                ...
                <thead>
                    <tr>
                        ...
                        <th soper="col">Photo</th>
                        <th soper="col">Tanggalaktif</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $row->date }}</td>
                        <td>
                            <a href="tampilkanpelayan/{{ $row->id }} "
    ...
    $('.delete').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = "/deletepelayan/" + id + ""
                Swal.fire(
                    'Dihapus!',
                    'Data sudah terhapus',
                    'success'
