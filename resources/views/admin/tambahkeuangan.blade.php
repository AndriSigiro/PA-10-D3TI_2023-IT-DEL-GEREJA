    ...
    <div class="content-wrapper">
        ...
        <h1 class="text-center mb-4" style="font-family: 'Josefin Sans', sans-serif;">Tambah data Keuangan</h1>
        <div class="container">
            <div class="row justify-content-center">
                <div class="card">

                    <div class="card-body">
                        <form action="/insertkeuangan" method="POST" enctype="multipart/form-data ">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="pemasukan" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Jumlah Pengeluaran </label>
                                <input type="number" class="form-control" name="pengeluaran" id="exampleInputEmail1"
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
        ...
        form.addEventListener('submit', (event) => {
            if (tanggal.value === '' || pemasukan.value === '' || pengeluaran.value === '') {
