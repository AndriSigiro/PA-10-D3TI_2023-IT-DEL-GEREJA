                        ...
                        <div class="card-body">
                            <form action="/updatejadwal/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="namaibadah"
                                        value="{{ $data->namaibadah }}" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Ayat Alkitab</label>
                                    <input type="text" class="form-control" name="ayatalkitab"
                                        value="{{ $data->ayatalkitab }}" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Hari & Tanggal</label>
                                    <input type="date" class="form-control" name="haritanggal"
                                        value="{{ $data->haritanggal }}" id="exampleInputPassword1">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Pelayan Ibadah</label>
                                    <input type="text" class="form-control" name="pelayan" id="exampleInputEmail1"
                                        value="{{ $data->pelayan }}" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Lokasi Ibadah</label>
                                    <input type="text" class="form-control" name="lokasiibadah" id="exampleInputEmail1"
                                        value="{{ $data->lokasiibadah }}" aria-describedby="emailHelp">
                                </div>
