                    ...
                    <form action="/updatekeuangan/{{ $data->id }}" method="POST" enctype="multipart/form-data ">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="tanggal" id="exampleInputEmail1"
                                value="{{ $data->tanggal }}" aria-describedby="emailHelp">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pemasukan" id="exampleInputEmail1"
                                value="{{ $data->pemasukan }}" aria-describedby="emailHelp">

                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Jumlah Pengeluaran</label>
                            <input type="text" class="form-control" name="pengeluaran" id="exampleInputEmail1"
                                value="{{ $data->pengeluaran }}" aria-describedby="emailHelp">
