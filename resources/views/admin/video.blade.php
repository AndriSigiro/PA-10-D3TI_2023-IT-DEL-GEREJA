...
<div class="content-wrapper">
    ...
    <h1 class="text-center mb-4" style="font-family: 'Rowdies', cursive;"> video</h1>
    <div class="container">
        <a href="/tambahvideo" type="button" class="btn btn-success">Tambah+</a>
        <div class="row">
    ...
    $('.delete').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = "/deletevideo/" + id + ""
                Swal.fire(
                    'Dihapus!',
                    'Data sudah terhapus',
                    'success'
